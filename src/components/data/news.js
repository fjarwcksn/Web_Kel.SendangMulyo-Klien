...
export const news = [
  {
    id: 1,
    title: "Pemkot Semarang Respon Cepat Tangani Tanggul Jebol di Kali Plumbon",
    date: "03/02/2025",
    time: "12:00",
    bidang: "Umum",
    description: `Kepala Dinas Kebudayaan dan Pariwisata (Disbudpar) Kota Semarang, Wing Wiyarso, mengatakan bahwa Wali Kota Semarang, Agustina akan memerankan Kanjeng Mas Ayu Tumenggung Purbodiningrum dalam prosesi Dugderan yang akan digelar Jumat (28/2) besok.
...
”Karena Dugderan ini merupakan salah satu budaya kearifan lokal yang hanya ada di Kota Semarang. Ini event besar pertama yang dilakukan oleh ibu Wali kota sekaligus ajang perkenalan kepada masyarakat,” pungkasnya.`,
  ...
  },
  {
    ...
    description: `Menindaklanjuti keluhan masyarakat terkait tidak berfungsinya pompa Kali Tenggang...`,
    image: img2,
  },
  {
    id: 3,
    title:
      "Genangan Air di SendangMulyo Kulon Cepat Surut, Pemkot Semarang Intens Upayakan Mitigasi",
    date: "05/02/2025",
    time: "12:00",
    bidang: "Umum",
    description: `Kondisi genangan yang sempat terjadi di wilayah SendangMulyo Kulon akibat intensitas hujan yang sangat tinggi...`,
    image: img3,
  },
  {
    id: 4,
    ...
    time: "08:00",
    bidang: "Berita",
    description: `Pemerintah Kota atau Pemkot Semarang melalui Dinas Pekerjaan Umum (DPU) gerak cepat melakukan perbaikan jalan...`,
    image: img3,
  },
];
